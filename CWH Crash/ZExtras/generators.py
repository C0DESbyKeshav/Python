...
# * As you can see, generators ko execute hone mein significantly bohat kam time lagta hai compared to creating a list and printing each element jissmein time bhi jaata hai aur memory bhi.
# * Aisa isliye kyuki generators kuch bhi pahile se store nahi karta hai woh mauke pe hi values ko generate karke yield kar deta hai.
